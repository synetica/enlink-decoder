...
function decode_packet() {
    ...
    var obj = decodeUplink(hex_string);
...
function decodeUplink(hex_string) {
    ...
    var msg = {};
    msg.eui = "00-00-00-00-99-99-99-99";
    msg.port = 99;
    msg.payload = p;
    var reply = nodered_decoder(msg);
  ...
  function nodered_decoder(msg) {
    ...
    if (msg.payload) {
      if (msg.payload.length === 0) {
        return "Error: msg.payload.length";
      }
    } else {
